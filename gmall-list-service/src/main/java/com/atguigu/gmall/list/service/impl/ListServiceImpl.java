...
public class ListServiceImpl implements ListService {
    ...
    public SkuLsResult search(SkuLsParams skuLsParams) {
            String query = makeQueryDsl(skuLsParams);
        ...
        SkuLsResult skuLsResul=  makeResultForearch(skuLsParams,searchResult);
        return skuLsResul;
    }

    private SkuLsResult makeResultForearch(SkuLsParams skuLsParams  ,SearchResult searchResult) {
    ...
    private String makeQueryDsl(SkuLsParams skuLsParams) {
